...
BEGIN
    ...
    DROP TEMPORARY TABLE IF EXISTS infoProvider;
    CREATE TEMPORARY TABLE infoProvider(
    ...
    VALUES ('SE2321000198-019448', 'Primärvård Södra Hälsingland',                              'SE2321000198-054394', 'VO Alfta Din hälsocentral'),
           ...
           ('', '?',                                                                            'SE2321000198-054928', 'Badverksamhet Sandviken'),
    ...
    UPDATE FRAGASVAR f
    INNER JOIN infoProvider i ON f.ENHETS_ID = i.originalId
