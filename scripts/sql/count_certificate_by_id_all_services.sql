...
BEGIN
   ...
   SELECT COUNT(*) AS row_count FROM intygstjanst.RELATION WHERE FROM_INTYG_ID = certIdToCount;
   SELECT COUNT(*) AS row_count FROM intygstjanst.RELATION WHERE TO_INTYG_ID = certIdToCount;
   SELECT COUNT(*) AS row_count FROM intygstjanst.ARENDE WHERE INTYGS_ID = certIdToCount;
   SELECT COUNT(*) AS row_count FROM intygstjanst.APPROVED_RECEIVER WHERE CERTIFICATE_ID = certIdToCount;
   SELECT COUNT(*) AS row_count FROM intygstjanst.SJUKFALL_CERT WHERE ID = certIdToCount;
   SELECT COUNT(*) AS row_count FROM intygstjanst.SJUKFALL_CERT_WORK_CAPACITY WHERE CERTIFICATE_ID = certIdToCount;
   SELECT COUNT(*) AS row_count FROM intygstjanst.CERTIFICATE_METADATA WHERE CERTIFICATE_ID = certIdToCount;
   SELECT COUNT(*) AS row_count FROM intygstjanst.CERTIFICATE_STATE WHERE CERTIFICATE_ID = certIdToCount;
   SELECT COUNT(*) AS row_count FROM intygstjanst.ORIGINAL_CERTIFICATE WHERE CERTIFICATE_ID = certIdToCount;
   SELECT COUNT(*) AS row_count FROM intygstjanst.CERTIFICATE WHERE ID = certIdToCount;


    -- ******** COUNTING FROM INTYGSADMIN DATABASE ********
   SELECT COUNT(*) AS row_count FROM intygsadmin.intyg_info WHERE intyg_id = certIdToCount;
   ...
   SELECT COUNT(*) AS row_count FROM statistik.intyghandelse WHERE CORRELATIONID = certIdToCount;
   SELECT COUNT(*) AS row_count FROM statistik.intygsenthandelse WHERE CORRELATIONID = certIdToCount;
   SELECT COUNT(*) AS row_count FROM statistik.intygcommon WHERE INTYGID = certIdToCount;
   SELECT COUNT(*) AS row_count FROM statistik.messagewideline WHERE intygid = certIdToCount;
   SELECT COUNT(*) AS row_count FROM statistik.wideline WHERE correlationId = certIdToCount;
   ...
   SELECT COUNT(*) AS row_count FROM statistik.hsa WHERE id = certIdToCount;
    ...
    SELECT COUNT(*) AS row_count FROM webcert.CERTIFICATE_EVENT WHERE CERTIFICATE_ID = certIdToCount;
    ...
    SELECT COUNT(*) AS row_count FROM webcert.HANDELSE WHERE INTYGS_ID = certIdToCount;
    SELECT COUNT(*) AS row_count FROM webcert.SIGNATUR WHERE INTYG_ID = certIdToCount;
    SELECT COUNT(*) AS row_count FROM webcert.REFERENS WHERE INTYG_ID = certIdToCount;
    SELECT COUNT(*) AS row_count FROM webcert.PAGAENDE_SIGNERING WHERE INTYG_ID = certIdToCount;
    ...
    SELECT COUNT(*) AS row_count FROM webcert.ARENDE WHERE INTYGS_ID = certIdToCount;
    SELECT COUNT(*) AS row_count FROM webcert.ARENDE_UTKAST WHERE INTYGS_ID = certIdToCount;
    SELECT COUNT(*) AS row_count FROM webcert.CERTIFICATE_EVENT_FAILED_LOAD WHERE CERTIFICATE_ID = certIdToCount;
    SELECT COUNT(*) AS row_count FROM webcert.CERTIFICATE_EVENT_PROCESSED WHERE CERTIFICATE_ID = certIdToCount;
    ...
    SELECT COUNT(*) AS row_count FROM webcert.FRAGASVAR WHERE INTYGS_ID = certIdToCount;
    SELECT COUNT(*) AS row_count FROM webcert.INTYG WHERE INTYGS_ID = certIdToCount;
   ...
   SELECT COUNT(*) AS row_count FROM certificate_service.certificate WHERE CERTIFICATE_ID = certIdToCountCS;
